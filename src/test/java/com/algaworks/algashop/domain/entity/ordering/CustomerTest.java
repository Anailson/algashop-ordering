package com.algaworks.algashop.domain.entity.ordering;
...
import com.algaworks.algashop.domain.valueobject.CustomerId;
import com.algaworks.algashop.domain.valueobject.FullName;
import com.algaworks.algashop.domain.valueobject.LoyaltyPoints;
...
class CustomerTest {
    ...
    @Test
    void giver_unarchivedCustomer_whenArchive_shouldAnonymize(){
        Customer customer = new Customer(
                new CustomerId(),
    ...
    void given_brandNewCustomer_whenAddLoyaltyPoints_shouldSumPoints() {
        ...
        customer.addLoayltyPoints(new LoyaltyPoints(20));
    ...
    void given_brandNewCustomer_whenAddInvalidLoyaltyPoints_shouldGenerateException() {
        ...
        Assertions.assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(()-> customer.addLoayltyPoints(new LoyaltyPoints(0)));

        Assertions.assertThatExceptionOfType(IllegalArgumentException.class)
                .isThrownBy(()-> customer.addLoayltyPoints(new LoyaltyPoints(-10)));
    }
