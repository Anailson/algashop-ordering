...
public class CustomerPersistenceEntity extends AbstractAggregateRoot<CustomerPersistenceEntity> {
    ...
    @Embedded   //para mapear os campos corretamente no banco de dados.
    @AttributeOverrides({
    ...
    @Version
    private Long version;  //Um campo @Version para controle de concorrência otimista.
    ...
    public Collection<Object> getEvetns(){
