...
/**
 * Responsável por converter objetos do domínio ({@link Order})
 * para o modelo de persistência ({@link OrderPersistenceEntity}).
 *
 * Atua como um Assembler, isolando a camada de domínio da camada de infraestrutura,
 * garantindo que regras de negócio não vazem para o modelo de banco de dados.
 *
 * Também realiza a conversão de Value Objects (Billing, Shipping, Address, etc.)
 * para seus respectivos objetos embutidos (Embeddables) utilizados pela JPA.
 *
