...
import static com.algaworks.algashop.domain.exception.ErrorMessages.*;
...
public class Customer {
    ...
    public void addLoayltyPoints(LoyaltyPoints loyaltyPointsAdded) {
        verifyIfChangeable();
