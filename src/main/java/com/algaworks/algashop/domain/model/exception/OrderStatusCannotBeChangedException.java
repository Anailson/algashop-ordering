...
import com.algaworks.algashop.domain.model.entity.OrderStatus;
import com.algaworks.algashop.domain.model.valueobject.id.OrderId;

import static com.algaworks.algashop.domain.model.exception.ErrorMessages.ERROR_ORDER_STATUS_CANNOT_BE_CHANGED;
